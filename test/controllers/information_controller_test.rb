...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { body: @information.body, category: @information.category, title: @information.title } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { body: @information.body, category: @information.category, title: @information.title } }
